...
1. **Build** your own Docker image by running
   ...
   For each chosen code cleaner, pass a `--build-arg` with a name-version pair. The build uses the Dockerfile of the repository at above URL, which refers to release `0.17.0` here.
...
[↻ Available versions](https://pkgs.alpinelinux.org/packages?name=aspell&branch=v3.13)
...
[↻ Available versions](https://pkgs.alpinelinux.org/packages?name=astyle&branch=v3.13)
...
[↻ Available versions](https://pkgs.alpinelinux.org/packages?name=clang&branch=v3.13)
...
[↻ Available versions](https://pkgs.alpinelinux.org/packages?name=git&branch=v3.13)
...
[↻ Available versions](https://pkgs.alpinelinux.org/packages?name=hunspell&branch=v3.13)
...
[↻ Available versions](https://pkgs.alpinelinux.org/packages?name=elixir&branch=v3.13)
...
[↻ Available versions](https://pkgs.alpinelinux.org/packages?name=tidyhtml&branch=v3.13)
...
[↻ Available versions](https://pkgs.alpinelinux.org/packages?name=libxml2-utils&branch=v3.13)
